...
using defaults, parsing `images.google.com` would yield:
...
Using `ignore_private => false` enables private TLDs.  Parsing `example.blogspot.com` would yield:
